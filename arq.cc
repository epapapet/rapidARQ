...
void CARQAcker::delete_lost_and_affected_coded(set<int> packets_to_remove)
{
...
bool CARQAcker::delete_lost_and_find_affected_coded(int pkt_to_remove)
{
...
void CARQAcker::delete_known_and_affected_coded_and_lost(set<int> packets_to_remove){
