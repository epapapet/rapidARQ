...
if {$arg_cnt != 13} {
    puts "# usage: ns <scriptfile> <bandwidth> <propagation_delay> <window_size> <cbr_rate> <pkt_size> <err_rate> <burst_duration> <ack_rate> <num_rtx> <rate_k> <timeout> <simulation_time> <seed>"
...
set receiver [$ns link-arq $window $apppktSize $rate_k $timeout_period $num_rtx $n1 $n3 [lindex $argv 12] [lindex $argv 7]]
