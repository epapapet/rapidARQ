...
if {$arg_cnt != 11} {
    puts "# usage: ns <scriptfile> <bandwidth> <propagation_delay> <window_size> <cbr_rate> <pkt_size> <err_rate> <ack_rate> <num_rtx> <timeout> <simulation_time> <seed>"
...
set receiver [$ns link-arq $window $apppktSize $timeout_period $num_rtx $n1 $n3 [lindex $argv 10] [lindex $argv 6]]
