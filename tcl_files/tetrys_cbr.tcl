...
if {$arg_cnt != 13} {
    puts "* usage: ns <scriptfile> <bandwidth> <propagation_delay> <window_size> <cbr_rate> <pkt_size> <err_rate> <ack_rate> <rate_k> <ack_period> <timeout> <simulation_time> <seed> <experiment_id>"
...
set receiver [$ns link-arq $window $apppktSize $rate_k $ack_period $timeout_period $n1 $n3 [lindex $argv 11] [lindex $argv 6] [lindex $argv 12]]
