...
$ns at 0.0 "$receiver print-parameters [expr {double(round(100*[lindex $argv 5])) + double(round(100*[lindex $argv 6]))/100}] [lindex $argv 7] [lindex $argv 10] [lindex $argv 11]"
$ns at 0.0 "$cbr start"
